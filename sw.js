...
var V='tv-v10-1';
var CORE=['./','index.html','assets/css/tokens.css?v=8','assets/css/fx.css?v=6','assets/js/fx.js?v=7','assets/js/render.js?v=2','assets/js/config.js?v=2','assets/js/nav.js?v=5','favicon.svg','404.html'];
